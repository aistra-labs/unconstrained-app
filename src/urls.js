...
export const URLS = {
    ...
    GET_PURCHASED_COURSES: `${BASE_URL}/payment/products`,
    CHECKOUT: (productId) => `${BASE_URL}/payment/checkout?productId=${productId}`,
    LAST_TRANSACTION: `${BASE_URL}/payment/transactions`,
};
